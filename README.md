...
Course version 4 adds reactive explosions and distance scoring through the entire crash. It keeps existing records, hats and discoveries. Previous daily records are labeled as an earlier course, and an unfinished earlier daily continues as a regular tour with its equipment and progress preserved. Current daily records use the revised course conditions. Outdated friend links explain that a fresh run is needed.
