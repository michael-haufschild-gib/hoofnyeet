...
/**
 * Playback speed of the landing replay as a fraction of real time, so the clip
 * runs at half speed and occupies twice its recorded length.
 */
export const REPLAY_RATE = 0.5;
/**
 * The cue times for a landing, in seconds on the landing phase clock and all
 * derived from the moment of contact: the follow-up beats, the slice of the
 * recording to show again, and `freeze`, the hold on the impact frame.
 */
...
/**
 * Wall-clock seconds the slow-motion replay of a landing occupies, which is how
 * long the replay phase runs before the results take over.
 */
